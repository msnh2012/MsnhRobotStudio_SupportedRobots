...
void setup()
{
  ...
  //J1    0~10240~20480   -120~120      0      0    y = x/240*20480+10240
  //J2    0~5582~14115    -78.5~120     0      -90  y = (x+78.5)/198.5*14115
  //J3    0~6569~22569    73.9~-180     0      90   y = (-x+73.9)/253.9*22569
  //J4    0~8960~17920    -180~180      0      0    y = x/360*17920+8960
  //J5    0~8400~10080    -45~225       0      -90  y = (x+45)/270*10080
  //J6    0~8960~17920    -180~180      0      0    y = x/360*17920+8960

  //机械零位
  stepper1.setCurrentPosition(10240);  
  stepper4.setCurrentPosition(8960);
  stepper5.setCurrentPosition(5040);
  stepper6.setCurrentPosition(8960);
