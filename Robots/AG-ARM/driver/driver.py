...
def calSteps(angles):
	try:
		out = []
		out.append(int(angles[0]/240*25600+12800))
		out.append(int(angles[1]/120*12800+6400))
		out.append(int((angles[2]+60)/240*25600))
		#out.append(int((-angles[2]+180)/240*25600)) # -180~60
		out.append(int(-angles[3]/360*32000+16000))
		out.append(int(angles[4]/240*20266+10133))
		out.append(int(angles[5]/360*25600+12800))
		return out
